...
const Index = () => {
  return (
    <Box maxW="1200px" m="auto">
      <VStack spacing={8} p={{ base: 3, md: 5 }}>
      <Heading as="h1" size="2xl" textAlign="center">Hamster Skötsel</Heading>
      <Image src="/images/hamster-care.jpg" alt="Hamster Care" boxSize={{ base: "90%", md: "300px" }} m="auto" />
      <Box>
        ...
        <Image src="/images/hamster-food.jpg" alt="Hamster Food" boxSize={{ base: "90%", md: "300px" }} m="auto" />
      </Box>
      <Box>
        ...
        <Image src="/images/hamster-housing.jpg" alt="Hamster Housing" boxSize={{ base: "90%", md: "300px" }} m="auto" />
      </Box>
      <Box>
        ...
        <Image src="/images/hamster-health.jpg" alt="Hamster Health" boxSize={{ base: "90%", md: "300px" }} m="auto" />
      </Box>
    </VStack>
  );
};
